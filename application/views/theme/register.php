...
<div class="container-fluid set-help_img">
	<div class="container p-5">
						...
						<div class="row" id="form">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label for="name" class="control-label text-dark" style="font-size: 16px;">Name<span
							...
							<div class="col-lg-6">
								<div class="form-group ">
									<label for="phone" class="control-label text-dark" style="font-size: 16px;">Phone
										No<span class="text-danger">*</span></label>
									<input type="text"
										oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')"
										maxlength="10" class="form-control" value="<?php echo set_value('phone') ?>"
							...
							<div class="col-lg-12">
								<div class="form-group">
									<label for="email" class="control-label text-dark"
										style="font-size: 16px;">Email</label>
							...
							<div class="col-lg-12">
								<div class="form-group ">
									<label for="address_1" class="control-label text-dark" style="font-size: 16px;">Address
										Line 1<span class="text-danger">*</span></label>
									<input type="text" class="form-control" placeholder="Address 1" value="<?php echo set_value('address_1') ?>"
							...
							<div class="col-lg-12">
								<div class="form-group">
									<label for="address_2" class="control-label text-dark" style="font-size: 16px;">Address
										Line 2</label>
									<input type="text" class="form-control" value="<?php echo set_value('address_2') ?>"
										id="address_2" placeholder="Address 2" name="address_2">
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label for="password" class="control-label text-dark"
										style="font-size: 16px;">Password<span class="text-danger">*</span></label>
							...
							<div class="col-lg-6">
								<div class="form-group ">
									<label for="password_2" class="control-label text-dark" style="font-size: 16px;">Retype
										Password<span class="text-danger">*</span></label>
									<input type="password" class="form-control"
										value="<?php echo set_value('password_2') ?>" placeholder="Re Enter Password" id="password_2" name="password_2">
								</div>
							</div>
							...
							<div class="col-lg-6">
								<?php if (config_item('enable_epin') == "Yes" && config_item('free_registration') == "No") {
									...
									<div class="form-group" id="e_pin">
										...
										} ?>" class="form-control" placeholder="E-Pin" id="epin" name="epin">
									</div>
								<?php } ?>
							</div>
								...
								<?php if (config_item('leg') !== "1" && config_item('show_placement_id') == "Yes" && config_item('autopool_registration') == "No") { ?>
									<div class="form-group">
										...
										<input type="text" class="form-control"
											onchange="get_user_name('#position', '#psn_res')" id="position" value="<?php if ($this->uri->segment(3) !== "epin") {
												$uri4 = $this->uri->segment(4);
											}
											;
											echo set_value('position', $uri4) ?>" name="position" id="position"
											placeholder="Where you want to place the ID">
									</div>
									<?php
								} ?>
							</div>
								...
								<?php if (config_item('leg') == "1" && config_item('show_placement_id') == "Yes") { ?>
									<div class="form-group">
										...
										<input type="text" class="form-control"
											...
											;
											echo set_value('position', $uri4) ?>" name="position"
											placeholder="Where you want to place the ID">
									</div>
									<?php
								} ?>
							...
							<div class="col-lg-6">
								<?php if (config_item('leg') == "1") {
									...
									if (config_item('show_leg_choose') == "Yes" && config_item('autopool_registration') == "No") {
										?>
										<div class="form-group ">
											<label for="leg" class="control-label text-dark" style="font-size: 16px;">Position<span
													class="text-danger">*</span></label>
											<select class="form-control" id="leg" name="leg">
												...
												<?php foreach ($leg as $key => $val) { ?>
													<option value="<?php echo $key; ?>" <?php echo ($lg == $key) ? "Selected" : " " ?>>
														<?php echo $val; ?></option>
												<?php } ?>
											</select>
										</div>
		...
		<div class="col-sm-7">
				...
				?>
							...
							<div class="col-lg-6">
								<?php if (config_item('show_join_product') == "No" && config_item('free_registration') == "No") {
									...
									<div class="form-group " id="amt_to_pay">
										<label for="amt_to_pay" class="control-label text-dark" style="font-size: 16px;">Amount
											You Want to Pay ?</label>
										<input type="text" required value="<?php echo set_value('amt_to_pay') ?>"
											class="form-control" id="amt_to_pay" name="amt_to_pay">
									</div>
								<?php } ?>
							</div>
							...
							<div class="col-lg-6">
								<?php if (config_item('enable_pg') == "Yes" && config_item('free_registration') == "No") {
									?>
									<div class="form-group ">
										<label for="epin" class="control-label text-dark"
											style="font-size: 16px;color: #3a80d7">Payment Gateway</label><br />
										<input type="checkbox" value="yes" id="pg" name="pg"
											onclick="toogle_div('#e_pin', '#pg')"> I'll Pay
										Using
										Payment
										Gateway.
									</div>
			...
			<div class="col-lg-3  ">
				<img src="<?php echo base_url() ?>media/theme_assets/img/bg/reg_1.jpg" class="reg_iiii" alt="">
			</div>
