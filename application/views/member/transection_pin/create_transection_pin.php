...
<?php if($tran_pin_have_or_not['transection_pin'] == ""){?>
    <h2 style="padding-left:4rem;color:white;">Create Transection Pin</h2><hr>
<?php echo form_open() ?>
<div class="col-sm-5"style="padding:4rem 4rem 4rem 4rem;" id="con_man_1">
    ...
    <!-- <p style="color:#5275e8;"><span>&nbsp;<b>Reset your<a href="<?//php echo base_url();?>member/re_transection_pin">Transection PIN</a></b> </span></p> -->
...
<div class="row">
        ...
        <div class="col-md-5 box-shdow with-con" id="man-con"style="display:none;">
            ...
            <input type="password" name="show_password" id="transection_pin" required class="form-control" placeholder="Enter Login Password*"><br />
...
<?php echo form_close() ?>
<?php }else{?>   
    <?php $this->load->view('member/transection_pin/reset_tran_pin');?>
<?php }?>
<style>
        #man-con {
