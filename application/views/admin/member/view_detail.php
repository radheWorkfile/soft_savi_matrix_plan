...
<div align="center">
    <img src="<?php echo $data->my_img ? base_url($data->my_img) : base_url('uploads/default.jpg'); ?>" class="img-responsive img-rounded" style="max-width: 200px">
</div>
<div class="row view">
...
<div>
    <h4>Bank Passbook</h4>
    <?php echo $profile_data->pass_book ? '<a target="_blank" href="' . base_url('uploads/' . $profile_data->pass_book) . '">Click Here</a>' : 'Not Updated'; ?>
</div>